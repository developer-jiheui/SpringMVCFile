...
<script>
    ...
    // //button에 data주입
    // var buttons = document.getElementsByClassName(btn-detail);
    // for (let i = 0; i < buttons; i++) {
    //     buttons[i].add
    //     //let contactNo = buttons[i].setAttribute('data',"contact-no: "+ buttons[i].getAttribute('contact-no'));
    //     let contactNo = buttons[i].getAttribute('contactNo');
